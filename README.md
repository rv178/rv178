...
[![Things I use](https://skillicons.dev/icons?i=linux,bash,rust,c,lua,ts,js,sass,neovim,bootstrap,tailwind,git,godot,docker,express,react,nextjs,nodejs,py,qt,regex,mongodb)](https://skillicons.dev)
