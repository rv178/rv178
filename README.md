...
[![Things I use](https://skillicons.dev/icons?i=linux,bash,rust,c,lua,ts,neovim,bootstrap,tailwind,git,docker,express,react,nextjs,nodejs,py,qt,regex,mongodb)](https://skillicons.dev)
